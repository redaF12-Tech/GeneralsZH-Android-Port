...
public class SetupActivity extends Activity {
    ...
    // Which picker (game folder vs mod folder) the storage-permission round
    // trip should resume into; defaults to the game-folder request code.
    ...
    private void saveModPath(String path) {
        ...
        // with overwrite=true so Mod BIGs outrank GeneralsZH and Base Generals.
